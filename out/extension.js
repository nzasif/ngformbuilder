...
const mat_field_templates_1 = require("./mat-field-templates");
let tabs = '';
let form = '';
let formName = '';
...
function prepareObjectToEval(selectedText) {
...
function evalObject(selectedText) {
    let obj;
...
function parseJson(selectedText) {
    try {
...
function generateMatFormField(ctrlName, value) {
    if (typeof (value) === 'boolean') {
        return mat_field_templates_1.matRadioGroup.replace('ctrlName', ctrlName).replace(/\$tabs/g, tabs);
    }
    if (typeof (value) === 'number') {
        return mat_field_templates_1.matInputField.replace('ctrlName', ctrlName).replace(/\$tabs/g, tabs).replace('ctrlType', 'number');
    }
    switch (determineMatFieldType(ctrlName)) {
        case "matInput":
            return mat_field_templates_1.matInputField.replace('ctrlName', ctrlName)
                .replace(/\$tabs/g, tabs).replace('ctrlType', 'text');
        case "matSelect":
            return mat_field_templates_1.matSelectField.replace('ctrlName', ctrlName)
                .replace(/\$tabs/g, tabs);
        case "matRadio":
            return mat_field_templates_1.matRadioGroup.replace('ctrlName', ctrlName)
                .replace(/\$tabs/g, tabs);
        case "matCheckbox":
            return mat_field_templates_1.matCheckBox.replace('ctrlName', ctrlName)
                .replace(/\$tabs/g, tabs);
        case "textArea":
            return mat_field_templates_1.matTextAreaField.replace('ctrlName', ctrlName)
                .replace(/\$tabs/g, tabs);
        default:
            return mat_field_templates_1.matInputField.replace('ctrlName', ctrlName)
                .replace(/\$tabs/g, tabs).replace('ctrlType', 'text');
...
function determineMatFieldType(ctrlName) {
